...
public class Alarm_Picker extends Fragment implements AlarmUpdate {
    ...
    private DataSetChanged dataChangeCallBack;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState)
    {
        ...
        if(getArguments()!=null) {
            ...
            switchSnooze.setChecked(newAlarm.isSnoozeOn());
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newAlarm.setActiveSnooze(false);
                if(label_text.getText().length()!=0) {
                    newAlarm.setLabel(label_text.getText().toString());
                }
                else {
                    newAlarm.setLabel(newAlarm.getLabel());
                }
                ...
                Log.i("Time@TimePicker",String.valueOf(newAlarm.getMillisecondTime()));
        ...
        switchSnooze.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                newAlarm.setSnoozeFeature(isChecked);
            }
        });
    ...
    public void deleteAlarm()
    {
        ...
        newAlarm.removeFromSchedule(getContext());
    }
